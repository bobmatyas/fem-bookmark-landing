...
menuBookmarking.addEventListener("click", () => { changeFeatureTab('bookmarking'), addRedHover('bookmarking_underline') } );

const menuSpeedy = document.getElementById('menu_speedy');
menuSpeedy.addEventListener("click", () => { changeFeatureTab('speedy'), addRedHover('speedy_underline')} );

const menuEasy = document.getElementById('menu_easy');
menuEasy.addEventListener("click", () => { changeFeatureTab('easy'), addRedHover('easy_underline')} );
